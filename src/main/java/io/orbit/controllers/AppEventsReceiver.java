...
import io.orbit.controllers.pluginui.PluginsPageController;
...
public class AppEventsReceiver
{
    ...
    private void registerListeners()
    {
        ...
        menuBarController.addEventHandler(MenuBarViewEvent.PLUGINS, event -> Platform.runLater(PluginsPageController::show));

...
public interface JavaScriptParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterComment(JavaScriptParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#comment}.
	 * @param ctx the parse tree
	 */
	void exitComment(JavaScriptParser.CommentContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code putedPropertyExpressionAssignment}
	 * labeled alternative in {@link JavaScriptParser#propertyAssignment}.
	 * @param ctx the parse tree
	 */
	void enterPutedPropertyExpressionAssignment(JavaScriptParser.PutedPropertyExpressionAssignmentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code putedPropertyExpressionAssignment}
	 * labeled alternative in {@link JavaScriptParser#propertyAssignment}.
	 * @param ctx the parse tree
	 */
	void exitPutedPropertyExpressionAssignment(JavaScriptParser.PutedPropertyExpressionAssignmentContext ctx);
	/**

grammar CSS3;
@lexer::header { package io.orbit.text.antlr.css; }
@parser::header { package io.orbit.text.antlr.css; }
...
// Namespaces
// https://www.w3.org/TR/webtools-namespaces-3/
namespace
...
// Variable
// https://www.w3.org/TR/webtools-variables-1
var
...
// SerializableFont face
// https://www.w3.org/TR/2013/CR-webtools-fonts-3-20131003/#font-face-rule
fontFaceRule
...
// Viewport
// https://www.w3.org/TR/webtools-device-adapt-1/
viewport
    : Viewport ws '{' ws declarationList? '}' ws
    ;

// Counter style
// https://www.w3.org/TR/webtools-counter-styles-3/
counterStyle
    : CounterStyle ws ident ws '{' ws declarationList? '}' ws
    ;

// SerializableFont feature values
// https://www.w3.org/TR/webtools-fonts-3/
fontFeatureValuesRule
...
SubstringMatch
    : '*='
    ;
// https://www.w3.org/TR/webtools-fonts-3/#font-face-rule
FontFace

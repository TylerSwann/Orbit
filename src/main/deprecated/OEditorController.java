...
import io.orbit.api.text.TextEditorPane;
    ...
    private void registerSelectionListeners()
    {
        ...
        tabPane.getSelectionModel().selectedItemProperty().addListener(event -> {
            ...
            if (tab != null && tab.getUserData() != null && tab.getContent() == null && tab.getUserData() instanceof OrbitFile)
            {
                ...
                //VirtualizedScrollPane<OrbitEditor> scrollPane = new VirtualizedScrollPane<>(editor);
            ...
            if (tab != null && tab.getContent() != null && tab.getContent() instanceof VirtualizedScrollPane)
            {
                VirtualizedScrollPane scrollPane = (VirtualizedScrollPane) tab.getContent();
                OrbitEditor editor = (OrbitEditor) scrollPane.getContent();
        ...
        tabPane.getTabs().addListener((ListChangeListener<Tab>) c -> {
            ...
            tabPane.getTabs().forEach(tab -> {
                ...
                {
                    VirtualizedScrollPane scrollPane = (VirtualizedScrollPane) tab.getContent();
                    if (scrollPane.getContent() instanceof OrbitEditor)
                    {
                        OrbitEditor editor = (OrbitEditor) scrollPane.getContent();
                        updated.add(editor);
                    }

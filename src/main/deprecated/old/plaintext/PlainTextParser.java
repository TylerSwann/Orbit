...
public class PlainTextParser extends Parser {
	...
	public PlainTextParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class DocumentContext extends ParserRuleContext {
		public TerminalNode ANY() { return getToken(PlainTextParser.ANY, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PlainTextListener ) ((PlainTextListener)listener).enterDocument(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PlainTextListener ) ((PlainTextListener)listener).exitDocument(this);
		}
	}
